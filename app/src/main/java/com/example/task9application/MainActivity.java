package com.example.task9application;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        search_floating = findViewById(R.id.etName);
        ...
        search_floating.setOnClickListener(new View.OnClickListener() {
            ...
            private void api_key(final String City) {
                ...
                Request request = new Request.Builder()
                        .url("http://api.openweathermap.org/data/2.5/weather?q="+City+"&appid=ed4a86380886f86fda1581953f6762f4&units=metric")
                        .get()
                        .build();
